# Generated by Django 2.0.1 on 2018-02-06 03:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('depth_uom', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='products_depth', to='products.DimensionUOM')),
                ('height_uom', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='products_height', to='products.DimensionUOM')),
                ('language', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='products.Language')),
        ...
        migrations.AddField(
            model_name='product',
            name='width_uom',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='products_width', to='products.DimensionUOM'),
        ),
    ]
